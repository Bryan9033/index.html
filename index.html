...
<body>
    ...
    <h2 class>Tom Yum Goong: A Spicy Thai Delight</h2>
    ...
    <ol>
        <li><em>Simmer</em> the broth for 10minutes</li>
        <li>Add lemongrass, galangal, and kaffir lime leave</li>
        <li><em>Stir</em> in shrimp and <em>cook</em> until pink</li>
        <li><em>Season</em> with fiah sauce, lime juice, and chill paste</li>
    ...
    <table border="1" align="center" height="500" width="75%">
        <caption class="one"><strong>Recipe Details</strong></caption>
        <tr class="one">
        ...
        <tr>
            <td colspan="2"><strong>Serving Suggestions</strong>: Serve with steamead rice or jasmine tea.</td>
        </tr>
    </table>
</body>
</html>
